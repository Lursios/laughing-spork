  ...
  return (
      <div className="flex flex-col">
        <div className="flex flex-col mb-5 w-fit ">
          <h1 className="text-2xl text-extrabold">UPDATE A POST</h1>
          <p className="text-base text-bold">Please Select First Before Filling The Form</p>
          <Select options={updateOptions} defaultInputValue="" className="w-[364px] my-2" onChange={handleChange} />
        </div>
        <FormProvider {...methods}>
          <form className="flex flex-col flex-1 gap-7" onSubmit={handleSubmit(onSubmit)} >  
